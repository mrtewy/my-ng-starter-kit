...
gulp.task('init', ['dev:concatjs', 'dev:concatcss', 'dev:minifyhtml','dev:imageminify']);
gulp.task('watcher', ['dev:concatjs', 'dev:concatcss', 'dev:minifyhtml','dev:imageminify','watch']);
